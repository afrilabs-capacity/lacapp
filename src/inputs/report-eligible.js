          ...
          return (
            <div key={option.key} style={{ margin: "1em" }}>
              ...
              <input
                ...
                type="radio"
                onChange={(e) => {
                  updateReport("eligible", e.target.value);
                  formik.handleChange(e);
                }}
                onBlur={formik.handleBlue}
                value={option.value}
                checked={formik.values.eligible === option.value}
              />
            </div>
          );
        })}
