  ...
  return (
    <>
      <CRow className="text-center mb-4 mt-5">
        <CCol>
          <h1 className="text-center btn-site-theme">Monthly Report Form</h1>
        </CCol>
      </CRow>
      <CRow>
        <CCol md="8" className="col-centered">
            ...
            <CCardBody>
              <form onSubmit={formik.handleSubmit}>
                ...
                <CRow>
                  <CCol xs="12">
                    <CFormGroup>
                      <CLabel htmlFor="ccnumber" className="font-weight-bold">
                        First Name
                      </CLabel>
                      <CInput
                        name="first_name"
                  ...
                  <CCol xs="12">
                    ...
                    {formik.touched.marital_status &&
                      formik.errors.marital_status && (
                        <TextError>{formik.errors.marital_status}</TextError>
                      )}
                  </CCol>
                </CRow>
                ...
                <CRow>
                  <CCol xs="12">
                    ...
                    {formik.touched.case_type && formik.errors.case_type && (
                    ...
                    <CRow>
                      <CCol xs="12">
                        <CFormGroup>
                          ...
                          <ReportComplaints formik={formik} name="complaints" />
                        </CFormGroup>
                        {formik.touched.complaints &&
                          formik.errors.complaints && (
                            <TextError>{formik.errors.complaints}</TextError>
                          )}
                      </CCol>
                    </CRow>
                  )
                  ...
                  <CRow>
                    <CCol xs="12">
                      <CFormGroup>
                        ...
                        <ReportState formik={formik} name="state_of_origin" />
                      </CFormGroup>
                      {formik.touched.state_of_origin &&
                        formik.errors.state_of_origin && (
                          <TextError>{formik.errors.state_of_origin}</TextError>
                        )}
                    </CCol>
                  </CRow>
                ) : (
                  ...
                  <CCol xs="6">
                    ...
                    {formik.touched.date_case_granted &&
                      formik.errors.date_case_granted && (
                        <TextError>{formik.errors.date_case_granted}</TextError>
                      )}
                  </CCol>
                </CRow>
                ...
                <CRow className="mt-4">
                  ...
                  <CCol xs="4 text-center">
                    <CFormGroup>
                      ...
                      {formik.touched.eligible && formik.errors.eligible && (
                  ...
                  <CCol xs="4 text-center">
                    <CFormGroup>
                      ...
                      <br />
                      <ReportActiveCase formik={formik} name="active_case" />
                    ...
                    <CFormGroup>
                      ...
                      {formik.touched.completed_case &&
                        formik.errors.completed_case && (
                          <TextError>{formik.errors.completed_case}</TextError>
                        )}
                    </CFormGroup>
                  </CCol>
                </CRow>
                ...
                <CRow className="mt-4">
                  <CCol xs="6 text-center">
                    <CFormGroup>
                      ...
                      <br />
                      <ReportCaseOutcome formik={formik} name="case_outcome" />
                      {formik.touched.case_outcome &&
                        formik.errors.case_outcome && (
                          <TextError>{formik.errors.case_outcome}</TextError>
                        )}
                    </CFormGroup>
                  </CCol>
