...
const DashboardUpdateUser = React.lazy(() =>
  import("./views/dashboard/DashboardUpdateUser")
);
...
/*lAC ROUTES*/
const DashboardAddReport = React.lazy(() =>
  import("./views/dashboard/DashboardAddReport")
);

const DashboardMonthlyReport = React.lazy(() =>
