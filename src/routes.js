...
const routes = [
  ...
  { path: '/users/add', exact: true,  name: 'Users', component: DashboardAddUser },
  { path: '/users/:id', exact: true, name: 'User Details', component: User },

  { path: '/announcements/add', exact: true, name: 'Add Announcement', component: User },
{ path: '/posts/all', exact: true, name: 'Add Post', component: DashboardAllPost },
  { path: '/posts/add', exact: true, name: 'Add Post', component: DashboardAddPost },
  { path: '/posts/edit/:id', exact: true, name: 'Add Post Test', component:DashboardEditPost },
  { path: '/programmes/all', exact: true, name: 'Manage Programmes', component:DashboardAllProgrammes },
